...
\section{EXPERIENCE}
  ...
  \resumeItemListStart
    ...
    \resumeItem{Development \textbf{Infrastructure as Code} with \textbf{Pulumi} for AWS IAM/EC2/RDS/Route53...etc}
    \resumeItem{Development \textbf{Automation} with \textbf{Ansible} for EC2 initialization, Java apps with docker-compose...etc}
  ...
  \resumeItemListStart
    \resumeItem{Participated in multiple cloud deployment projects utilizing \textbf{AWS, GCP, Alibaba Cloud, CloudFlare, and other public cloud services}.}
      ...
      \resumeSubItem{Maintained Kubernetes clusters for multiple client projects and provided optimization and troubleshooting solutions. For example, \textbf{replacing VM-based Nginx servers with Kubernetes' built-in ingress-nginx and implementing automated certificate renewal using ingress-nginx and Cert Manager}.}
