...
\section{PROJECTS}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Building a system based on a simple Client-server model based on \textbf{Python frameworks(Selenium/Pandas/
            undetected-chromedriver...)} and \textbf{Relational Databases(MariaDB)} which scraping data from our target web servers}
          \resumeItemListEnd          
    \resumeSubHeadingListEnd
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Building a system based on a simple Client-server model which monitors \textbf{air-quality, temperature and humidity}}
          \resumeItemListEnd          
    \resumeSubHeadingListEnd
