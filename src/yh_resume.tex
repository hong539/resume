...
\section{PROJECTS}
    ...
    \resumeProjectHeading
        ...
        \resumeItemListStart
          ...
          \resumeItem{ \textbf{Languages \& Tools}: discord developer portal, Proxmox Virtual Environment, Arch Linux, Python, discord.py, pandas, sqlalchemy, PostgreSQL, podman}
        \resumeItemListEnd          
    \resumeSubHeadingListEnd
