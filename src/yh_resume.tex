...
\section{EXPERIENCE}
  ...
  \resumeItemListStart
    \resumeItem{Operation in many projects with \textbf{AWS, GCP, Alibaba Cloud, CloudFlare...etc}}
    \resumeItem{Participate in many projects for \textbf{System Operation/Migration/Refactoring/Backup}}
    \resumeItem{Maintain \textbf{Kubernetes clusters of customers's development, test, staging and production environments.}}
    \resumeItem{Build and Maintain \textbf{CI/CD pipelines with GitLab for customers}}
