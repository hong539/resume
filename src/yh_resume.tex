...
\section{EXPERIENCE}
  ...
  {System migration}{}
  \resumeItemListStart
    \resumeItem{Virtualized deployment to Kubernetes}
  \resumeItemListEnd    
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{ \textbf{Languages \& Tools}: Raspberry Pi, NodeMCU, C/C++, JavaScript/HTML/CSS, Bootstrap, PHP, phpMyAdmin, MariaDB, Apache HTTP Server}
          \resumeItemListEnd          
    \resumeSubHeadingListEnd
