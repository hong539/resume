  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Gitlab runner CI/CD pipelines}
      \resumeItemListEnd  

    \resumeSubheading
      {Coding}{Jan. 2021 -- Present}
      {C (programming language)}{}
      \resumeItemListStart
        \resumeItem{basic syntax}
        \resumeItem{MySQL Connector/C}        
      \resumeItemListEnd
...
\section{PROJECTS}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Web-crawler}} {Jan. 2022 -- May. 2022}
          \resumeItemListStart
            \resumeItem{Building a system based on \textbf{Python frameworks(Selenium/Pandas/
            undetected-chromedriver...)} which scraping data from our target web servers}
          \resumeItemListEnd          
    \resumeSubHeadingListEnd
...
\section{SKILLS}
 \begin{itemize}[leftmargin=0in, label={}]
    \small{\item{
     ...
     \textbf{Tools}     {: Docker, Kubernetes, Nginx, Git, Bash, Vim, VS Code, GitHub, GitLab, GitLab Runner, LaTeX}
    }}
 \end{itemize}
