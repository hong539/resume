...
\section{EXPERIENCE}
  ...
  \resumeItemListStart
    \resumeItem{\textbf{Cryptocurrency Exchange System} on \textbf{AWS, On-premise} with more than \textbf{200 EC2/EKS/VM nodes} across \textbf{development, test, staging and production environments.}}
      \resumeSubItem{Participated in \textbf{Deployment of On-premise self-managed: Kubernetes cluster, MySQL, RocketMQ, Redis, Nacos, Harbor}...etc.}
...
\section{PROJECTS}
    ...
    \resumeProjectHeading
        ...
        \resumeItemListStart
          ...
          \resumeItem{\textbf{Advanced search features for who want make some records or fix the broken preview from some outside URLs.}}
          \resumeItem{\textbf{Fix Links Previews.}}          
          \resumeItem{\textbf{Tech Stack}: Python, Bash, discord.py, fastapi, pydantic, sqlalchemy, Linux, Docker, Nginx, Cloudflare...etc}
        \resumeItemListEnd          
    \resumeSubHeadingListEnd
