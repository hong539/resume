...
\section{EXPERIENCE}
  ...
  \resumeSubheading
  {System/DevOps/SRE Engineer}{Jun. 2025 -- Current}
  {Logic Solutions Inc.}{}  
  \resumeItemListStart
    \resumeItem{\textbf{Quantum Product} on \textbf{AWS, On-premise} with more than \textbf{200 EC2/EKS/VM nodes} across \textbf{development, test, staging and production environments.}}
      \resumeSubItem{Maintained AWS resources with \textbf{Gitlab/Terraform/Terragrunt/AtlantisTerraform Pull Request Automation/Packer}}
      \resumeSubItem{Maintained Automation tasks with \textbf{Ansible}}
      \resumeSubItem{Maintained Bastion Jumphost server with \textbf{Golang/Go kit}}
      \resumeSubItem{Maintained CI/CD pipelines with \textbf{Jenkins/Groovy scripts}}
      \resumeSubItem{Maintained Observability with \textbf{Grafana/Prometheus/*-exporters/Alertmanager/Consul}}
      \resumeSubItem{\textbf{Tech Stack}: JavaScript/TypeScript, Angular, Java, Spring Boot, C#, .NET, RabbitMQ, Amazon RDS for MySQL, Amazon RDS for Microsoft SQL Server, Python, Bash, Linux, AWS, Gitlab, Jenkins, Groovy, Docker, Kubernetes...etc}
  \resumeItemListEnd  
...
\section{PROJECTS}
    ...
    \resumeSubHeadingListStart
    \resumeProjectHeading
        {\textbf{LiveTerm}} {May. 2023 -- Present}
        \resumeItemListStart
          \resumeItem{Building \textbf{a e-portfolio website} based on \textbf{Cveinnt/LiveTerm} to make a portal to link all my personal websites.}          
          \resumeItem{\textbf{Tech Stack}: JavaScript/TypeScript, HTML5, CSS, Bash, node.js, React, Next.js, Linux, Docker, Nginx, Cloudflare...etc}
        \resumeItemListEnd          
    \resumeSubHeadingListEnd

    \resumeSubHeadingListStart
    \resumeProjectHeading
        {\textbf{sauce-man}} {May. 2023 -- Present}
        \resumeItemListStart
          \resumeItem{Building \textbf{a discord bot} based on \textbf{Rapptz/discord.py} to make \textbf{discord app bertter to: }}
          \resumeItem{\textbf{Advanced search features for who want make some records.}}
          \resumeItem{\textbf{Fix Links Previews.}}          
          \resumeItem{\textbf{Tech Stack}: Python, Bash, discord.py, fastapi, pydantic, sqlalchemy, PostgreSQL, Linux, Docker, Nginx, Cloudflare...etc}
        \resumeItemListEnd          
    \resumeSubHeadingListEnd
