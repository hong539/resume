...
\section{EXPERIENCE}
  ...
  \resumeItemListStart
    \resumeItem{\textbf{Quantum Product Systems} on \textbf{AWS, On-premise}}
      \resumeSubItem{Manage AWS resources with \textbf{Gitlab/Terraform/Terragrunt/AtlantisTerraform Pull Request Automation/Packer}}
      \resumeSubItem{Development and Operation Automation tasks with \textbf{Ansible}}      
      \resumeSubItem{Magage CI/CD pipelines with \textbf{Jenkins/Groovy scripts}}
