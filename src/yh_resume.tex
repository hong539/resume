...
\section{PROJECTS}
    ...
    \resumeProjectHeading
        ...
        \resumeItemListStart
          ...
          \resumeItem{ \textbf{Languages \& Tools}: Kubernetes, k6, kubectl-graph, Tekton, C++, ffmpeg, Golang, go-callvis, go-swagger, Alibaba Cloud, GCP, CDN network, JavaScript, Node.js}
        \resumeItemListEnd          
    \resumeSubHeadingListEnd
