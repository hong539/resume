...
\section{EXPERIENCE}
  ...
  \resumeItemListStart
    \resumeItem{\textbf{Quantum Product Systems} on \textbf{AWS, On-premise}}
      ...
      \resumeSubItem{\textbf{Tech Stack}: Linux, Windows Server, AWS, Gitlab, Terraform, Terragrunt, AtlantisTerraform Pull Request Automation, Packer, Ansible, Jenkins, Groovy, Bash, Python, Golang, JavaScript/TypeScript, Angular, Java, Spring Boot, RabbitMQ, Bash, Docker, Kubernetes...etc}
  \resumeItemListEnd
