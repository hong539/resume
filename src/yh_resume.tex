...
\section{EXPERIENCE}
  ...
  \resumeItemListStart
    \resumeItem{Deploy architecture from Java spring microservices to Kubernetes}
    \resumeItem{Deploy architecture from VMs to Dcoker/Kubernetes}
...
\section{PROJECTS}
    ...
    \resumeProjectHeading
        ...
        \resumeItemListStart
          \resumeItem{Design a discord bot \textbf{sauce man} with \textbf{Python} coding, \textbf{an API wrapper discord.py}, \textbf{a PostgreSQL}}
          \resumeItem{Setup My development environment with \textbf{ProxmoxVE/Arch Linux/pyenv/pipenv} and running a sauce man bot under My homelab infrastructure}
          \resumeItem{ \textbf{Languages \& Tools}: discord developer portal, Proxmox Virtual Environment, Arch Linux, Python, discord.py, pandas, sqlalchemy, PostgreSQL, Docker engine}
        \resumeItemListEnd          
    \resumeSubHeadingListEnd
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Extend My skills with doing \textbf{MDN Web Docs: Django Tutorial: The Local Library website}}
            \resumeItem{Setup My development environment with \textbf{ProxmoxVE/Arch Linux/pyenv/poetry} and running a local-library-website with \textbf{Python Django Webframework} under My homelab infrastructure}
            \resumeItem{Research what are \textbf{WSGI/ASGI/Gunicorn} when deploy a Django project}
            \resumeItem{Will add some styles with \textbf{tailwindcss} to make this website Beautiful in the future}
            \resumeItem{ \textbf{Languages \& Tools}: Proxmox Virtual Environment, Arch Linux, Python, Django, Gunicorn, WSGI, ASGI, JavaScript/HTML/CSS, PostgreSQL, SQLite, Docker engine, Tailwind CSS}
          \resumeItemListEnd          
    \resumeSubHeadingListEnd
