...
\section{EXPERIENCE}
  ...
  \resumeItemListStart
    ...
    \resumeItem{Subsystem research and deploy: \textbf{Ingress-NGINX, Cert-manager, Prometheus, Grafana, Redis, RabbitMQ, Elasticsearch, Fluentbit, Kibana, Gitlab runner, Tekton, KubeSphere}}
  \resumeItemListEnd                 
