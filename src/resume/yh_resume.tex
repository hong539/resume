    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{ \textbf{Languages \& Tools}: Grafana, Git, Gitlab, Python, Requests, Beautiful Soup, Selenium, pandas, SQLAlchemy, MariaDB, docker, docekr-compose, Golang, chromedp, javascript, Puppeteer}
          \resumeItemListEnd          
    \resumeSubHeadingListEnd
